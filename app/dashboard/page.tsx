    ...
    <div className="space-y-6">
      ...
      <div className="grid gap-4 sm:grid-cols-2 lg:grid-cols-4">
        ...
        <DashboardCard
          ...
          description="Bookings &amp; calendar coming soon"
          icon={
            <svg className="h-5 w-5" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor">
      ...
      <div className="rounded-xl border border-brand-200 bg-white p-5">
        <div className="flex items-center gap-3">
          ...
          <div>
            <h3 className="text-sm font-semibold text-gray-900">Booking calendar coming soon</h3>
            <p className="text-xs text-gray-500">
              Create bookings, send WhatsApp confirmations, and manage your daily schedule.
            </p>
          </div>
        </div>
      </div>
